...
public class ControlCoreUiCommand extends AbstractCommand implements IModCommand {
    ...
    public void register(ControlCore plugin) {
        // Resolve ControlPanel from the DI container
        if (_controlPanel == null) {
            _controlPanel = plugin.getServiceProvider().getRequiredService(ControlPanel.class);
        }
    ...
    protected CompletableFuture<Void> execute(@Nonnull CommandContext context) {
        ...
        return _controlPanel.openControlPanel(
            player,
